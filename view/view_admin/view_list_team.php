    ...
    <?php 
      ...
      foreach($result2 as $row){
        ...
        <tr> 
            ...
            <td width="8%"></td>  
            <td width="5%"><button class="btn btn-primary btn-sm"><a style="color: white;">เเก้ไข</a></button></td>  
            <td width="5%"><button class="btn btn-danger btn-sm"><a style="color: white;" onclick="return confirm('คุณต้องการลบ ผู้เล่น คนนี้ใช่หรือไม่?')">ลบ</a></button></td> 
        </tr> 
        <?php
          $no++;
          }
