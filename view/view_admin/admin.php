...
<body>
    ...
    <br>
    <h1 class="title">All Player</h1>
    <p class="title small-font">รายละเอียด Player ทั้งหมด <i class="bi bi-journals"></i></p> 
...
<!--navbar-->
    ...
    <?php 
      ...
      $obj = new method_stmt();
      $result2 = $obj->getPlayer();
      $no = 1;
      echo "<table id='customers'>
      <tr>
        <th width='4%'>No</th>
        <th width='20%'><a style='color:white;'href='view_list_name.php'>Player name</a></th>
        <th width='19%'><a style='color:white;'href='view_list_team.php'>Team</a></th>
        <th width='8%'></th>
        <th width='5%'></th>
        <th width='5%'></th>
      </tr>
      ...
      foreach($result2 as $row){
        ...
        <tr> 
            <td width='2%'><?=$no?>.</td>
            <td width="15%"><a style="color: black;" href=""><?=$row['first_name']?> <?=$row['last_name']?></a></td>
            <td width="19%"><a style="color: black;" href="">
            <div class="team_td">
            <?php
              switch($row['team']){ 
                  case "Arsenal":
            ...
            <td width="8%"></td>  
            <td width="5%"><button class="btn btn-primary btn-sm"><a>เเก้ไข</a></button></td>   
            <td width="5%"><button class="btn btn-danger btn-sm"><a href="../.././controller/con_delete_course.php?identifier=<?=$row['identifier']?>" style="color: white;" onclick="return confirm('คุณต้องการลบ ผู้เล่น คนนี้ใช่หรือไม่?')">ลบ</a></button></td> 
