...
<body>
        ...
        <div class="container-fluid">
            <img width="30" src="https://seeklogo.com/images/P/premier-league-logo-E8E0CE3AE6-seeklogo.com.png" alt="">
                    ...
                    foreach($rs2 as $row){ 
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="card h-100 opacity">
                                <a href="view_details_course.php?cs_id="><img class="card-img-top" src='<?=$row['image']?>'alt=""></a>
                                <div class="card-body">
                                    <h4 class="card-title">
